exports.DelSetWel = `Sheiko shita delete set welcome di grup ini`
exports.NoSetWel = `Mada arimasen set welcome di grup ini`
exports.DelSetLeft = `Sheiko shita delete set goodbye di grup ini`
exports.NoSetLeft = `Mada arimasen set goodbye di grup ini`
exports.doneSet = `Mae ni henko sa remashita`
exports.serverErr = `Gomen~ server sedang eror`
exports.limitLu = (m) =>{
...
exports.UmurXReg = () =>{
	return`Umur kamu terlalu tua, bukannya mati ehh malah main dengan watashi`
	}
exports.firstChat = (a, b, c) =>{
	return`Selamat ${a} ${b} 🤗, watashi adalah ${c} yaitu Danzz Bot. Ada yang bisa ${c} bantu?`
	}
exports.StartAbsen = () =>{
	return`Mulai Absen`
	}
exports.AddstikOk = (q, a, b, prefix, command) =>{
	return`Nice, Sukses Menambahkan ${q} Ke Dalam Database ${a}\n\nCek dengan cara ${prefix}${b}`
	}
...
exports.Addvn = () =>{
	return`Chottomatte, watashi akan mencoba untuk mengupload media ini ke database`
	}
...
exports.DahAbsen = () =>{
	return`Anata sudah absen`
	}
exports.DelAbsen = () =>{
	return`✅ Berhasil menghapus absen di group ini`
	}
exports.adaAbsen = () =>{
	return`Hwwwmm, Keknya masih ada sesi absen di group ini...`
	}
exports.SAbsen = () =>{
...
exports.UCmd = () =>{
	return`Anata tidak memiliki izin untuk mengubah perintah stiker ini`
	}
exports.HashCmd = () =>{
...
exports.OkMute = () => {
    return `Watashi Telah Di Mute Di Group Ini`
}
exports.OkUnMute = () => {
    return `Watashi Berhasil Di UnMute`
}
exports.OkUnBanC = () => {
    return `Watashi Berhasil Di unban chat`
}
exports.NoMute = () => {
    return `Watashi belum di ban dalam group ini`
}

exports.NoMsgBot = () => {
    return `Pesan tersebut bukan dikirim oleh watashi desu!`
}
exports.ToimgErr = () => {
    return `Gomen~ Saat Ini Belum Support Sticker Gif`
}
...
exports.BotSelf = () => {
    return `Sukses Ganti Ke Mode Self\n\nUntuk mengubah ke mode public silahkan gunakan nomor watashi`
}
...
exports.NoQouted = () => {
    return `Pesan Yang anata reply tidak mengandung reply`
}
...
exports.TbKimia = (soal, time, exp) => {
    return `Nani Arti Dari Simbol : *${soal}*?\nWaktu : ${time} detik\nHadiah : ${exp} XP`
}
...
exports.Dellist = () => {
    return `Mada ada list message di database`
}
...
exports.Anonymous = (pushname, prefix) => {
    return `Hai ${pushname} Irasshaimase di Anonymous Chat\n\nKetik ${prefix}start untuk mencari Teman Chat anda, atau bisa pencet tombol Search dibawah`
}
exports.Anon = () => {
    return `Cari Anata no Tomodachi`
}
exports.StopAnon = () => {
    return `Anata Sedang Tidak Berada Di Sesi Anonymous\n${prefix}start -- _cari pasangan baru_`
}
exports.AnonNew = () => {
    return `Cari Atarashi Tomodachi`
}
exports.AnonDahStop = () => {
    return `✅ Berhasil memberhentikan chat\n${prefix}start -- _cari pasangan baru_`
}
exports.StopAnonByFren = () => {
    return `⚠️ Sesi chat ini telah diberhentikan oleh Anata no chatto nakama_\n${prefix}start -- _cari pasangan baru_`
}
exports.AnonOn = () => {
    return `⚠️ Anata masih dalam sesi chat dengan partner!\n${prefix}skip -- _cari pasangan baru_\n${prefix}stop -- _hentikan dialog ini_`
}
exports.AnonFind = (prefix) => {
    return `_Istri Ditemukan, Gomen seharusnya Pasangan Ditemukan_\n${prefix}skip -- _cari pasangan baru_\n${prefix}stop -- _hentikan dialog ini_`
}
exports.AnonSearch = () => {
    return `🔎 Mohon chotto sedang mencari Anata no chatto\n${prefix}skip -- _cari pasangan baru_\n${prefix}stop -- _hentikan percarian ini_`
}
exports.NoAnon = () => {
    return `⚠️ Anata belum pernah memulai chat!\n${prefix}start -- _cari pasangan baru_`
}
...
exports.getBan = (a) => {
    return `⚠️ Gomen~nasai nomor anata telah di banned oleh owner\n\nOwner 👇\nwa.me/${a}`
}
...
exports.InfoMenu = () => {
    return `\n_Mencari informasi terkini melalui watashi_`
}
exports.KhususOwn = () => {
    return `\n_Fitur khusus owner watashi_`
}
exports.DataBor = () => {
    return `\n_Menyimpan sesuatu di database watashi_`
}
exports.MenuGc = () => {
    return `\n_Menampilkan fitur khusus group_`
}
exports.MenuAni = () => {
    return `\n_Mencari random gambar anime desu >\\<_`
}
exports.TagMem = () => {
...
exports.CovertWi = () => {
    return `\n_Mengkorversi sesuatu dengan watashi_`
}
exports.AnuFoto = () => {
...
exports.StikerWibu = () => {
    return `\n_Random stiker anime desu >\\<_`
}
exports.ImageDewasa = () => {
    return `\n_Random image anime 18+ :>_`
}
exports.MakeLogo = () => {
    return `\n_Untuk membuat logo menggunakan watashi_`
}
exports.oterMenu = () => {
    return `\n_Menu lainnya_`
}
exports.GameBot = () => {
    return `\n_Fitur untuk bermain dengan watashi_`
}
exports.RandRik = () => {
    return `\n_Random video tiktok_`
}
exports.RandCew = () => {
    return `\n_Random gambar cewe cantik •_•_`
}
exports.RamalOi = () => {
    return `\n_Ramalan masa kini_`
}
...
exports.BuatLogoLagi = () => {
    return `\n_Membuat logo keren dengan watashi_`
}
exports.SoundNih= () => {
    return `\n_Random sound_`
}
...
exports.SumberBot = () => {
    return `\n_Sumber script bot watashi ini_`
}
exports.Tqnya = () => {
    return `\n_Siapa aja yang berkontribusi di dalam bot watashi ini_`
}
exports.SetAh = () => {
    return `Mau set menu ya ?`
}
exports.KickAh = (gc) => {
    return `*Antilink Group Terdeteksi*\n\nAnata akan dikeluarkan dari group ${gc}`
    }
    exports.GjdKick = () => {
    return `Sepertinya anata mengirimkan link group ini, and anata tidak akan di keluarkan`
    }
/////////

/////////
exports.private = () =>{
	return`Fitur hanya bisa di gunakan di private chatto`
	}
exports.wait = () => {
    return `⏳ Chottmatte aniki`
}
exports.ok = () => {
    return `✅ Seiko shita`
}
...
exports.notAdmin = () => {
    return `❎ User anata bukan seorang admin! ❎`
}
...
exports.botNotAdmin = () => {
    return `Jadikan watashi sebagai admin terlebih dahulu! 🙏`
}
...
exports.menunya = (salam, pushname, botname) =>{
	return`Hai aniki ${pushname} 👋 Irasshaimase ${salam} , 
saya ${botname}, Watashi ini adalah Bot Beta Multi-Device Whatsapp.
`
}
...
1. スパムメールを送信しないでください
2. 電話しないで
3. 私を隣人のボットと比較しないでください
4. このグループに他のボットを追加しないでください

🗯️ Bot tidak atau lambat merespon ?
➡️ Mungkin dipengaruhi oleh jaringan, signal, banned oleh Whatsapp dan beberapa alasan.
...
│○ 𝖦𝖾𝗇𝖽𝖾𝗋 :
│○ 𝖠𝗌𝗄𝗈𝗍 :
╰❒ 𝖯𝖺𝗍𝗎𝗁𝗂 𝗋𝗎𝗅𝖾𝗌 𝗀𝗋𝗎𝗉 𝗒𝖺 aniki-sama ~`
}
exports.leave = () =>{
	return`Yah kok out 😣 Mental aman kan ani? >.<
Sayonara~`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Hai kak ☺️ 
Min'na-san bisa mendukung watashi agar bot ini tetap up to date dengan cara donasi
╭─❒
│○ DANA : 082351108031
│○ OVO  : 082351108031
│○ Gopay : 085245759983
